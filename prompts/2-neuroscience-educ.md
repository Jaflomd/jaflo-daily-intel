...
Eres un agente de inteligencia investigativa. Hoy es `<YYYY-MM-DD>`. Construye el **dossier diario** del dominio **Educación Médica & Neuroeducación** y publícalo en la galería.
...
1. **PubMed**: `("evidence-based education" OR "medical education" OR "health professions education" OR "neuroeducation" OR "educational neuroscience" OR "simulation" OR "competency-based medical education") AND "last 7 days"[dp]`
