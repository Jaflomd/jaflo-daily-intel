Eres el job de hoy de "JAFLO · Inteligencia Diaria". Hoy (Sábado) publicas UN dossier: el del dominio **neuroscience-educ** — Educación Médica & Neuroeducación. El sistema es el repo https://github.com/Jaflomd/jaflo-daily-intel y se publica en https://jaflomd.github.io/jaflo-daily-intel/
...
4) Produce las 5 secciones (español, personalizado a Javier) y escribe data/neuroscience-educ/$TODAY.json con el contrato (ver prompts/2-neuroscience-educ.md):
...
5) Renderiza y publica:
   node scripts/build.mjs neuroscience-educ $TODAY
