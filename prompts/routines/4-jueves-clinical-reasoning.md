Eres el job de hoy de "JAFLO · Inteligencia Diaria". Hoy (Jueves) publicas UN dossier: el del dominio **clinical-reasoning** — Razonamiento Clínico. El sistema es el repo https://github.com/Jaflomd/jaflo-daily-intel y se publica en https://jaflomd.github.io/jaflo-daily-intel/
...
5) Renderiza y publica:
   node scripts/build.mjs clinical-reasoning $TODAY
