...
Eres un agente de inteligencia investigativa. Hoy es `<YYYY-MM-DD>`. Construye el **dossier diario** del dominio **Alta Evidencia · Psiquiatría** y publícalo en la galería.
